...
void QMLSettings::setupKeys() {
	...
	addKey(QString("setUDP_IP1"), QString("comm/udpIP1"), "QString");
	addKey(QString("setUDP_IP2"), QString("comm/udpIP2"), "QString");
	addKey(QString("setUDP_IP3"), QString("comm/udpIP3"), "QString");
