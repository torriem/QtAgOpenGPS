...
Rectangle {
    ...
    Column{
        ...
        TextLine{ color: "white"; text: qsTr(""+ (Number(aog.percentLeft).toLocaleString(Qt.locale(), 'f', 0))+"%")}
        TextLine{ color: "white"; text: qsTr(""+ aog.timeTilFinished)}
        ...
        TextLine{ color: "white"; text: qsTr(""+ aog.workRate)}
    }
}
