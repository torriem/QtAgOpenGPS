...
AOGProperty property_setDisplay_colorDayFrame("display/colorDayFrame",QColor(210, 210, 230).rgb());
AOGProperty property_setDisplay_colorNightFrame("display/colorNightFrame",QColor(50, 50, 65).rgb());
AOGProperty property_setDisplay_colorSectionsDay("display/colorSectionsDay",QColor(27, 151, 160).rgb());
AOGProperty property_setDisplay_colorFieldDay("display/colorFieldDay",QColor(100, 100, 125).rgb());
AOGProperty property_setDisplay_isDayMode("display,dayMode",true);
AOGProperty property_setDisplay_colorSectionsNight("display/colorSectionsNight",QColor(27, 100, 100).rgb());
AOGProperty property_setDisplay_colorFieldNight("display/colorFieldNight",QColor(60, 60, 60).rgb());
...
AOGProperty property_setDisplay_colorTextNight("display/colorTextNight",QColor(230, 230, 230).rgb());
AOGProperty property_setDisplay_colorTextDay("display/colorTextDay",QColor(10, 10, 20).rgb());
...
AOGProperty property_setDisplay_colorVehicle("display/vehicleColor",QColor("White").rgb());
...
AOGProperty property_setColor_sec01("display/section1Color",QColor(249, 22, 10).rgb());
AOGProperty property_setColor_sec02("display/section2Color",QColor(68, 84, 254).rgb());
AOGProperty property_setColor_sec03("display/section3Color",QColor(8, 243, 8).rgb());
AOGProperty property_setColor_sec04("display/section4Color",QColor(233, 6, 233).rgb());
AOGProperty property_setColor_sec05("display/section5Color",QColor(200, 191, 86).rgb());
AOGProperty property_setColor_sec06("display/section6Color",QColor(0, 252, 246).rgb());
AOGProperty property_setColor_sec07("display/section7Color",QColor(144, 36, 246).rgb());
AOGProperty property_setColor_sec08("display/section8Color",QColor(232, 102, 21).rgb());
AOGProperty property_setColor_sec09("display/section9Color",QColor(255, 160, 170).rgb());
AOGProperty property_setColor_sec10("display/section10Color",QColor(205, 204, 246).rgb());
AOGProperty property_setColor_sec11("display/section11Color",QColor(213, 239, 190).rgb());
AOGProperty property_setColor_sec12("display/section12Color",QColor(247, 200, 247).rgb());
AOGProperty property_setColor_sec13("display/section13Color",QColor(253, 241, 144).rgb());
AOGProperty property_setColor_sec14("display/section14Color",QColor(187, 250, 250).rgb());
AOGProperty property_setColor_sec15("display/section15Color",QColor(227, 201, 249).rgb());
AOGProperty property_setColor_sec16("display/section16Color",QColor(247, 229, 215).rgb());
...
AOGProperty property_setSection_position1("tool/sectionpoition1","-2");
AOGProperty property_setSection_position2("tool/sectionpoition2","-1");
AOGProperty property_setSection_position3("tool/sectionpoition3","1");
AOGProperty property_setSection_position4("tool/sectionpoition4","2");
AOGProperty property_setSection_position5("tool/sectionpoition5","0");
AOGProperty property_setSection_position6("tool/sectionpoition6","0");
AOGProperty property_setSection_position7("tool/sectionpoition7","0");
AOGProperty property_setSection_position8("tool/sectionpoition8","0");
AOGProperty property_setSection_position9("tool/sectionpoition9","0");
AOGProperty property_setSection_position10("tool/sectionpoition10","0");
AOGProperty property_setSection_position11("tool/sectionpoition11","0");
AOGProperty property_setSection_position12("tool/sectionpoition12","0");
AOGProperty property_setSection_position13("tool/sectionpoition13","0");
AOGProperty property_setSection_position14("tool/sectionpoition14","0");
AOGProperty property_setSection_position15("tool/sectionpoition15","0");
AOGProperty property_setSection_position16("tool/sectionpoition16","0");
AOGProperty property_setSection_position17("tool/sectionpoition17","0");
...
AOGProperty property_setDisplay_brightness("display/brightness",80);
...
AOGProperty property_setTool_zones("tool/zones","2,10,20,0,0,0,0,0,0");
...
AOGProperty property_setAS_functionSpeedLimit("autosteer/functionSpeedLimit",5);
AOGProperty property_setAS_maxSteerSpeed("autosteer/maxSteerSpeed",15);
AOGProperty property_setAS_minSteerSpeed("autosteer/minSteerSpeed",1);
...
AOGProperty property_setDisplay_isSvennArrowOn("display/svennArrow",true);
AOGProperty property_setTool_isTramOuterInverted("tool/isTramOuterInverted",false);
AOGProperty property_setJobMenu_location("display/jobMenuLocation",QPoint(100, 100));
AOGProperty property_setJobMenu_size("display/jobMenuSize","900, 600");
AOGProperty property_setWindow_curveEditLocation("display/curveEditLocation",QPoint(40, 40));
AOGProperty property_setWindow_abLineEditLocation("display/abLineEditLocation",QPoint(40, 40));
